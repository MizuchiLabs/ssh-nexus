...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/MizuchiLabs/ssh-nexus/api/proto/gen/agent/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AgentServiceStreamProcedure = "/agent.v1.AgentService/Stream"
)
...
// Stream calls agent.v1.AgentService.Stream.
...
func (UnimplementedAgentServiceHandler) Stream(context.Context, *connect.BidiStream[v1.StreamRequest, v1.StreamResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("agent.v1.AgentService.Stream is not implemented"))
}
